...
for file in customize.sh module.prop service.sh post-fs-data.sh common_func.sh rom_spoof_block.sh sepolicy.rule daemon action.sh action_i18n.sh uninstall.sh; do
